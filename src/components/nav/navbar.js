                                    ...
                                    <Row className="align-items-center">
                                        ...
                                        <Col md={6}>
                                            <div className="helo_right_content">
                                                <h4> Heart and Cardiac Institutes  </h4>
                                                <p>We have an esteemed group of Cardiologist and CTVS Surgeons that offers comprehensive care to patients with provide complete care for various heart diseases.</p>
                                                <div className="h_list">
                                                    <ul>
                                                        <li> <FaCheckCircle className="circle" /> <strong>25+</strong>Years of Experience</li>
                                                        <li><FaCheckCircle className="circle" /><strong>60+</strong> Bone Marrow Transplants Done </li>
                                                        <li><FaCheckCircle className="circle" />Robotic Heart Surgery</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </Col>
